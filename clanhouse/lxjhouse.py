...
class house():
    ...
    def buildhouse(self):
        ...
        mc.setBlocks(x,y+6,z,x+10,y+6,z+10,241) #屋顶
        mc.setBlocks(x+5,y+1,z,x+6,y+3,z+1,0) #门       
        mc.setBlocks(x+10,y+2,z+4,x+10,y+4,z+5,102) #窗
...
def lxjhouse():
    ...
    lxjshouse = house([posx,posy,posz,L,W,H,M,roof,floor])
    lxjshouse.buildhouse()
